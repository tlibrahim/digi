<div id="edit-potentail-{{ @$p->id }}" class="modal fade" role="dialog">
  	<div class="modal-dialog">
    	<div class="modal-content">
      		...
      		<form method="post" action="{{ url('potentials/'.$p->id) }}">
	      		<div class="modal-body">
					@csrf
					<input name="_method" type="hidden" value="PUT">
					<div class="form-group" style="width: 100%">
						<label>Company Name</label>
						<input type="text" style="width: 100%" required placeholder="Company Name" value="{{ $p->companyname }}" name="companyname" class="form-control">
					</div>
					<div class="form-group" style="width: 100%">
