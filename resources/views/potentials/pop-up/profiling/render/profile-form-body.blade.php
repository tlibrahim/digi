				<div class="modal-body">
	                ...
	                <div class="form-group" style="width:100%">
	                  	<div class="form-group" style="width:100%">
	                    	...
	                    	<div class="col-md-3">
	                    		<select class="form-control" style="width:100%" name="seo_level_id">
	                    			@foreach($levels as $l)
	                    			<option {{ @$p->profile->seo_level_id == @$l->id ? 'selected' : '' }} value="{{ @$l->id }}">{{ @$l->level }}</option>
	                    			@endforeach
	                    		</select>
	                    	</div>
	                    	<div class="col-md-4">
	                  	...
	                  	<div class="form-group" style="width:100%">
	                    	...
	                    	<div class="col-md-3">
	                    		<select class="form-control" style="width:100%" name="sem_level_id">
	                    			@foreach($levels as $l)
	                    			<option {{ @$p->profile->sem_level_id == @$l->id ? 'selected' : '' }} value="{{ @$l->id }}">{{ @$l->level }}</option>
	                    			@endforeach
	                    		</select>
	                    	</div>
	                    	<div class="col-md-4">
	                  	...
	                  	<div class="form-group" style="width:100%">
	                      	...
	                      	<div class="col-md-3">
	                    		<select class="form-control" style="width:100%" name="gdn_level_id">
	                    			@foreach($levels as $l)
	                    			<option {{ @$p->profile->gdn_level_id == @$l->id ? 'selected' : '' }} value="{{ @$l->id }}">{{ @$l->level }}</option>
	                    			@endforeach
	                    		</select>
	                      	</div>
	                      	<div class="col-md-4">
