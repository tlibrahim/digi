            ...
            <h3 class="block-title">Add Meeting</h3>

      
              <form class="form-horizontal" action="base_forms_elements.html" method="post" onsubmit="return false;">
                  <div class="form-group">
                    <label class="col-md-3 control-label" for="example-datepicker1">Date</label>
                    <div class="col-md-7">
                  ...
                  <div class="form-group">
                      <label class="col-md-3 control-label" for="example-hf-password">Company</label>
                      <div class="col-md-7">
                  ...
                  <div class="form-group">
                      <label class="col-md-3 control-label" for="example-hf-password">Connection</label>
                      <div class="col-md-7">
                        <select class="form-control" id="contact1-subject" name="contact1-subject" >
                            <option value="1">Mohamed</option>
                            <option value="2">Hassan</option>
                            <option value="3">Shawa</option>

                        </select>
                      </div>
                  </div>
                  <div class="form-group">
                      <label class="col-md-3 control-label" for="example-hf-email">Type</label>
                      <div class="col-md-7">
                          <input class="form-control" type="text" id="example-hf-email" name="example-hf-email" placeholder="">
                      </div>
                  </div>
                  <div class="form-group">
                      <label class="col-md-3 control-label" for="example-hf-email">Location</label>
                      <div class="col-md-7">
                          <input class="form-control" type="text" id="example-hf-email" name="example-hf-email" placeholder="">
                      </div>
                  </div>
